...
- **Use Test Fixtures**: All contracts used for testing must be placed in or loaded from the `tests/fixtures/` directory, rather than creating ad-hoc files during test execution or hardcoding large contracts in the test files.
